...
\begin{enumerate}[leftmargin=1.5em]
    ...
    index, chunk count, and normalized chunk text.
...
\begin{tabularx}{\textwidth}{L{4.7cm} Y}
    ...
    and Gemini-powered semantic topic chunks. \\
...
\begin{tabularx}{\textwidth}{L{2.5cm} L{5cm} Y}
    ...
    \texttt{semantic} & Gemini sentence embeddings; cosine boundary threshold
    of 0.65; one-sentence overlap & Multi-topic reports and research \\
    \bottomrule
\end{tabularx}
...
\begin{itemize}[leftmargin=1.5em]
    ...
    boundary-aware chunks or higher-cost semantic topic detection based on
